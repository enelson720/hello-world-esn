...
# https://github.com/jupyterhub/oauthenticator/issues/107#issuecomment-323590830
c.JupyterHub.authenticator_class = 'lib.jupyter_oauth.GenericOAuthenticator'
c.OAuthenticator.client_id = os.getenv('HEROKU_OAUTH_ID')               # oauth2 client id for your app
c.OAuthenticator.client_secret = os.getenv('HEROKU_OAUTH_SECRET')       # oauth2 client secret for your app
c.GenericOAuthenticator.token_url = os.getenv('OAUTH2_TOKEN_URL')       # oauth2 provider's token url
c.GenericOAuthenticator.userdata_url = 'https://api.heroku.com/account' # oauth2 provider's endpoint with user data
c.GenericOAuthenticator.userdata_method = 'GET'                         # method used to request user data endpoint
# c.GenericOAuthenticator.userdata_params = {'scope': [ 'identity' ]}     # params to send for userdata endpoint
c.GenericOAuthenticator.username_key = 'email'                          # username key from json returned from user data endpoint
...
#c.JupyterHub.data_files_path = '/Users/flarco/anaconda3/share/jupyterhub'
...
# c.Spawner.args = ['--debug', '--disable-user-config']
# c.Spawner.args = ['--disable-user-config']
c.Spawner.environment = {
  "AWS_ACCESS_KEY_ID": os.getenv('AWS_ACCESS_KEY_ID'),
  "AWS_SECRET_ACCESS_KEY": os.getenv('AWS_SECRET_ACCESS_KEY'),
  "HEROKU_PREDICTION_REDSHIFT_URL": os.getenv('HEROKU_PREDICTION_REDSHIFT_URL'),
  "PRIMARY_DATABASE_URL": os.getenv('PRIMARY_DATABASE_URL'),
  "ANALYTICS_S3_BUCKET": os.getenv('ANALYTICS_S3_BUCKET', "dwh-analytics"),
}
...
# c.S3ContentsManager.bucket = "dwh-analytics"
